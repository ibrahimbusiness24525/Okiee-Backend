...
const SingleSoldPhoneSchema = new mongoose.Schema(
  {
    ...
    bankName: {
      type: String,
      required: function () {
        return this.sellingPaymentType === "Bank";
      },
    },
    ...
    exchangePhoneDetail: {
      type: String,
      required: function () {
        return this.sellingPaymentType === "Exchange";
      },
    },
    // Phone Details
    name: { type: String, required: true },
...
const BulkPhonePurchaseSchema = new mongoose.Schema(
  {
    ...
    status: {
      type: String,
      enum: ["Available", "Partially Sold", "Sold"],
      default: "Available",
    },
    dispatch: {
      type: Boolean,
...
const BulkPhonePurchase = mongoose.model(
  "BulkPhonePurchase",
  BulkPhonePurchaseSchema
);
...
const SingleSoldPhone = mongoose.model(
  "SingleSoldPhone",
  SingleSoldPhoneSchema
);
